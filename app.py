...
from ui import intake, cases, admin, chat, document_analyzer, tour  # noqa: E402  (each page exposes render())

PAGES = {"Guided tour": tour, "Intake": intake, "Cases": cases, "Ask Nyaya": chat,
         "Document Analyzer": document_analyzer}  # Admin only via ?page=admin
...
if page.startswith("guide-"):                                   # stage4: public how-to page
    ...
    st.sidebar.caption("Admin · Nyaya")
    admin.render()
